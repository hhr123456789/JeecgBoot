...
enum Api {
  ...
  dimensiontreeList = '/energy/emsDimension/queryMyDimensionTreeList',
  //dimensiontreeList = '/sys/sysDepart/queryMyDeptTreeList',
 ...
 * 获取维度树列表
 */
export const queryMydimensionTreeList = (params) => defHttp.get({ url: Api.dimensiontreeList, params }, { isTransformResponse: false });
