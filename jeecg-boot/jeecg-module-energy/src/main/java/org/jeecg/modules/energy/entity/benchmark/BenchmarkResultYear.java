...
/**
 * @Description: 能效对标结果年表
 * @Author: jeecg-boot
 * @Date: 2026-02-17
 * @Version: V1.0
 */
@Data
@TableName("tb_benchmark_result_year")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="tb_benchmark_result_year对象", description="能效对标结果年表")
public class BenchmarkResultYear implements Serializable {
