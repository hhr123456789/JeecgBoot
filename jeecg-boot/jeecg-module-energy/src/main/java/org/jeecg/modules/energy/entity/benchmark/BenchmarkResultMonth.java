 ...
 */
@Data
@TableName("tb_benchmark_result_month")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="tb_benchmark_result_month对象", description="能效对标结果月表")
public class BenchmarkResultMonth implements Serializable {
