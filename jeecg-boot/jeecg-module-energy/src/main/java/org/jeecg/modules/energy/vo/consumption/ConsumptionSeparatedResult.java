...
@Data
@ApiModel(value = "ConsumptionSeparatedResult", description = "设备能源统计-分开显示结果")
public class ConsumptionSeparatedResult implements Serializable {
    private static final long serialVersionUID = 1L;

    @ApiModelProperty(value = "显示模式", example = "separated")
    private String displayMode = "separated";

    @ApiModelProperty(value = "时间范围")
    private String timeRange;

    @ApiModelProperty(value = "图表列表")
    private List<Chart> charts;

    @Data
    @ApiModel(value = "Chart", description = "图表")
    ...
    public static class Series implements Serializable {
        ...
        @ApiModelProperty(value = "系列名称", example = "能耗")
        private String name;
